...
-- Ouro: Resumo Gerencial — KPIs agregados por situação, tipologia e status
with base_fichas as (select * from {{ ref("ouro_far_ficha_empreendimento") }})
...
from base_fichas
group by situacao_empreendimento, tipologia, status_execucao_simplificado, status_prazo
