...
-- Prata: Cadastro PJ Mensal — dados detalhados do empreendimento contratado
-- Fonte: bronze.bronze_shpt_monit_cad_pj_far_mensal
...
with
    cad_pj_raw as (
        select
            ...
            {{ parse_financial_value("vr_legalizacao_empreendimento") }}
            as vr_legalizacao,
            {{ parse_financial_value("vr_seguros_obrigatorios") }}
        ...
        from {{ ref("bronze_shpt_monit_cad_pj_far_mensal") }}
    )
