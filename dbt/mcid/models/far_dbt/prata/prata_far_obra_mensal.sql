...
-- Prata: Obra Mensal — evolução física do empreendimento
-- Fonte: bronze.bronze_shpt_monit_mov_obra_far_mensal
...
with
    obra_raw as (
        select
            ...
            {{ var('schema_udfs') }}.parse_date_br(dt_repactuacao) as dt_repactuacao,
        ...
        from {{ ref("bronze_shpt_monit_mov_obra_far_mensal") }}
    )
