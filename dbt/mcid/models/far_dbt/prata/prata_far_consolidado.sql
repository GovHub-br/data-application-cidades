...
-- Prata: Consolidado GFAR — propostas e dados de seleção/contratação
-- Fonte: bronze.bronze_shpt_his_mcidades_consolidado
...
with
    consolidado_raw as (
        ...
        from {{ ref("bronze_shpt_his_mcidades_consolidado") }}
    )
