...
-- Prata: Cadastro PJ Mensal — dados do empreendimento FDS (Entidades)
-- Fonte: bronze.bronze_shpt_monit_cad_pj_fds_mensal
...
with
    cad_pj_raw as (
        select
            ...
            {{ parse_financial_value("vr_total_contrapartidas") }}
            ...
            {{ parse_financial_value("vr_equipamentos_publicos") }}
            as vr_equipamentos_publicos,
            {{ parse_financial_value("vr_equipamento_uso_comum") }}
            as vr_equipamento_uso_comum,
            {{ parse_financial_value("vr_infraestrutura_incidente") }}
            as vr_infraestrutura,
            ...
            {{ parse_financial_value("vr_contrapartida_estado_infra") }}
            as vr_contrapartida_estado_infra,
            {{ parse_financial_value("vr_contrapartida_estado_terreno") }}
            as vr_contrapartida_estado_terreno,
            {{ parse_financial_value("vr_contrapartida_estado_complementar") }}
            as vr_contrapartida_estado_complementar,
            {{ parse_financial_value("vr_contrapartida_municipio_infra") }}
            as vr_contrapartida_municipio_infra,
            {{ parse_financial_value("vr_contrapartida_municipio_terreno") }}
            as vr_contrapartida_municipio_terreno,
            {{ parse_financial_value("vr_contrapartida_municipio_complementar") }}
            as vr_contrapartida_municipio_complementar,
            {{ parse_financial_value("vr_contrapartida_outras") }}
            ...
            {{ parse_financial_value("vr_sistema_alternativo_de_energia") }}
            as vr_energia_alternativa,
            {{ parse_financial_value("vr_sistema_aquecimento_solar") }}
        ...
        from {{ ref("bronze_shpt_monit_cad_pj_fds_mensal") }}
    )
