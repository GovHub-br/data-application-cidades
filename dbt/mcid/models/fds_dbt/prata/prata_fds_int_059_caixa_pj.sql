...
-- Prata: INT 059 — empreendimentos FDS da CAIXA (complementar)
-- Fonte: bronze.bronze_sftp_int059_fds_caixa_empreendimentos
...
with
    int059_raw as (
        ...
        from {{ ref("bronze_sftp_int059_fds_caixa_empreendimentos") }}
    )
