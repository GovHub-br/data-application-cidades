...
-- Prata: Financeiro Mensal — liberações financeiras FDS (Entidades)
-- Fonte: bronze.bronze_shpt_monit_mov_financ_fds_mensal
...
with
    financeiro_raw as (
        ...
        from {{ ref("bronze_shpt_monit_mov_financ_fds_mensal") }}
    )
