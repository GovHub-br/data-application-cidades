...
with
    obra_raw as (
        select
            ...
            -- Datas de entrega
            {{ parse_date_br('dt_prev_entrega_emprend') }} as dt_previsao_entrega,
            ...
            {{ parse_hist_numeric('vr_vigilancia') }} as vr_vigilancia,
        ...
        from {{ source("mcmv_staging", "novo_mcmv_fds_obra_mensal") }}
    )
