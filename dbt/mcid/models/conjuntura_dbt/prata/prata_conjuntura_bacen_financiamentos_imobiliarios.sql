...
-- Prata do conjuntura: financiamentos imobiliários PF/PJ (BACEN SGS).
-- Página 2/3, seção 3.
--
-- Contrato de saída: formato longo (data, tipo, valor), que é o que o ouro
...
-- A versão anterior desta prata despivotava sete colunas de JSON aninhado,
...
-- mesma: a Etapa 02 achata, a prata tipa.
--
