...
-- Prata do conjuntura: PIB da construção civil em % de crescimento.
...
--
-- Mantém os nomes de coluna da tabela manual: o ouro já os consome, e
...
from (
    ...
    from {{ ref('prata_conjuntura_ibge_pib_construcao_civil') }}
    group by 1, 2
) s
