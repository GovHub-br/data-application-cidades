...
-- Bronze do conjuntura: Faixa 3 Fundo Social (GEFUS).
--
...
-- prata, já dentro do banco. Projetar coluna aqui é transformação disfarçada
...
--     prata/ouro, que são as camadas de consumo.

select * from {{ fonte_lake('gefus_fundo_social', 'lake_staging') }}
