...
-- Bronze do conjuntura: FGTS-PF (Base_PF_FGTS, GEAVO/Caixa).
--
...
-- etapa bronze → prata, já dentro do banco. Projetar aqui é transformação
-- disfarçada.
--
...
from {{ fonte_lake('geavo_fgts_pf', 'lake_staging') }} as r
