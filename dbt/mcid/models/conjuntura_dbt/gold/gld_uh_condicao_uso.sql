...
-- Caixa, via slv_geavo_fgts_pf. Esta Silver contém o recorte
...
-- automatizada (`slv_abecip_financiamentos`), que tem a série
...
sbpe as (
    ...
    from {{ ref('slv_abecip_financiamentos') }} a
