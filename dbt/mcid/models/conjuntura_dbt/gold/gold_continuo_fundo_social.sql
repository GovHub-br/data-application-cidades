...
-- `gold_continuo_financiamento_pf_faixa` registrava que a base do GEAVO "não
...
-- 19.438).
--
-- ⚠️ Fica em gold SEPARADO, e não somado ao `gold_continuo_financiamento_pf_faixa`,
...
with mensal as (
    ...
    from {{ ref('silver_continuo_gefus_fundo_social') }}
)
