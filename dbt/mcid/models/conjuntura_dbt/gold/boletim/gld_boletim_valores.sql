...
-- NULL em vez de quebrar o cast.
    ...
    select
        'gld_boletim_p1_pib_construcao_civil_em_de_crescimento'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'gld_boletim_p1_lancamentos_por_regiao_cbic'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'gld_boletim_p1_vendas_por_regiao_cbic'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'gld_boletim_p1_cbic_lancamentos_e_vendas_totais'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'gld_boletim_p2_lancamentos_por_construtora_variacao'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'gld_boletim_p2_vendas_por_construtora_variacao'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'gld_boletim_p2_totais_das_empresas_levantadas_variacao'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'gld_boletim_p2_financiamentos_imobiliarios_bacen'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'gld_boletim_p2_financiamentos_habitacionais_uh'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'gld_boletim_p3_empregos_construcao_caged'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'gld_boletim_p3_pnad_continua_ocupados_e_rendimento_medio_re'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'gld_boletim_p3_producao_industrial_e_volume_de_vendas_varia'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'gld_boletim_p3_novos_financiamentos_imobiliarios_por_banco_'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'gld_boletim_p4_credito_imobiliario_pib'::text                as modelo,
        4                            as pagina,
    ...
    union all
    select
        'gld_boletim_p4_no_uh_por_condicao_de_uso'::text                as modelo,
        4                            as pagina,
    ...
    union all
    select
        'gld_boletim_p5_sbpe_construcao_unidades_e_valor_acum_no_tri'::text                as modelo,
        5                            as pagina,
    ...
    union all
    select
        'gld_boletim_p5_saldo_caderneta_de_poupanca_captacao_liquida'::text                as modelo,
        5                            as pagina,
    ...
    union all
    select
        'gld_boletim_p5_financiamento_pf_mcmv_por_faixa'::text                as modelo,
        5                            as pagina,
    ...
    union all
    select
        'gld_boletim_p6_sinapi_brasil_e_incc_m'::text                as modelo,
        6                            as pagina,
    ...
    union all
    select
        'gld_boletim_p6_ticket_medio_das_unidades_lancadas_vs_incc'::text                as modelo,
        6                            as pagina,
    ...
    union all
    select
        'gld_boletim_p7_indices_da_construcao_variacao'::text                as modelo,
        7                            as pagina,
