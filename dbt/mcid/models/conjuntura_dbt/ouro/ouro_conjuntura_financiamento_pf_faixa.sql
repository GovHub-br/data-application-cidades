...
-- Ouro do conjuntura: Financiamento PF MCMV por faixa de renda —
...
--
-- Validado contra o boletim 1T2026 (ver prata). A linha "Faixa 3 Fundo
...
with base as (
    ...
    from {{ ref('prata_conjuntura_geavo_cci_cca') }}
)
