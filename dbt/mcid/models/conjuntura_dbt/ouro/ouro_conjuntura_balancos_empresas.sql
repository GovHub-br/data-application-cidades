...
with base as (
    select * from {{ ref('prata_conjuntura_manual_trimestrais') }}
),

unpivoted as (

    select periodo, ano, trimestre, data_referencia, edicao, 'MRV' as empresa,
    ...
    select periodo, ano, trimestre, data_referencia, edicao, 'Cury',
        cury_lancamentos,
    ...
    select periodo, ano, trimestre, data_referencia, edicao, 'Tenda',
        tenda_lancamentos,
    ...
    select periodo, ano, trimestre, data_referencia, edicao, 'Direcional',
    ...
    select periodo, ano, trimestre, data_referencia, edicao, 'Pacaembu',
    ...
    select periodo, ano, trimestre, data_referencia, edicao, 'Plano & Plano',
