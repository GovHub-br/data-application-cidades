...
-- Ouro do conjuntura: PIB da construção civil em % de crescimento,
-- direto da API do IBGE (agregado de taxas de variação trimestrais), por
-- trimestre. Apoio/comparação à ouro_conjuntura_pib_construcao_civil_pct
-- (fonte MANUAL, oficial do boletim). A prata traz 4 variáveis de taxa (%)
...
with base as (
    select * from {{ ref('prata_conjuntura_ibge_pib_construcao_civil') }}
