...
-- Ouro do conjuntura: Índice ICST (confiança na construção, FGV-IBRE).
...
--
-- ⚠️ O BOLETIM USA A SÉRIE **COM AJUSTE SAZONAL**. Até 2026-08-30 este ouro
...
with base as (
    ...
    from {{ ref('prata_conjuntura_fgv_icst') }}
)
