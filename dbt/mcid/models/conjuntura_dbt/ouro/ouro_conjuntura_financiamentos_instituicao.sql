...
-- Ouro do conjuntura: Novos Financiamentos Imobiliários SBPE por
...
--
--   1. ABECIP automatizado (`prata_conjuntura_abecip_instituicoes`) — traz o
...
manual_largo as (
    ...
    where abecip_sbpe_fin_uh_acum_total is not null
      and not exists (
          ...
          where c.ano = {{ ref('prata_conjuntura_manual_mensais') }}.ano
            and c.mes = {{ ref('prata_conjuntura_manual_mensais') }}.mes
      )
),
