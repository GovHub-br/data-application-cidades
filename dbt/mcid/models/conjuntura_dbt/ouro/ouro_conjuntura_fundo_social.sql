...
-- Ouro do conjuntura: Faixa 3 Fundo Social (MCMV) — UH e valor,
...
-- `ouro_conjuntura_financiamento_pf_faixa` registrava que a base do GEAVO "não
...
-- 19.438).
--
-- ⚠️ Fica em ouro SEPARADO, e não somado ao `ouro_conjuntura_financiamento_pf_faixa`,
...
with mensal as (
    ...
    from {{ ref('prata_conjuntura_gefus_fundo_social') }}
)
