...
where coalesce(financiamento_pf_uh_pro_cotista_faixa_1, financiamento_pf_uh_pro_cotista_faixa_2,
               financiamento_pf_uh_pro_cotista_faixa_3, financiamento_pf_uh_pro_cotista_classe_media) is not null
