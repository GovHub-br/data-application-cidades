...
-- NULL em vez de quebrar o cast.
    ...
    select
        'ouro_conjuntura_boletim_p1_pib_construcao_crescimento'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p1_lancamentos_por_regiao_cbic'::text                as modelo,
        1                            as pagina,
    ...
    from {{ ref('ouro_conjuntura_boletim_p1_lancamentos_por_regiao_cbic') }}
    union all
    select
        'ouro_conjuntura_boletim_p1_lancamentos_por_regiao_cbic'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p1_vendas_por_regiao_cbic'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p1_cbic_lancamentos_e_vendas_totais'::text                as modelo,
        1                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p2_lancamentos_por_construtora_variacao'::text                as modelo,
        2                            as pagina,
    ...
    from {{ ref('ouro_conjuntura_boletim_p2_lancamentos_por_construtora_variacao') }}
    union all
    select
        'ouro_conjuntura_boletim_p2_lancamentos_por_construtora_variacao'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p2_vendas_por_construtora_variacao'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p2_totais_empresas_variacao'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p2_financiamentos_imobiliarios_bacen'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p2_financiamentos_habitacionais_uh'::text                as modelo,
        2                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p3_empregos_construcao_caged'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p3_pnad_ocupados_rendimento'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p3_producao_e_vendas_variacao'::text                as modelo,
        3                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p3_financiamentos_por_banco'::text                as modelo,
        3                            as pagina,
    ...
    select
        ...
        case when "VALOR (R$ bi)"::text ~ '^-?[0-9]*\.?[0-9]+$'
             then "VALOR (R$ bi)"::text::numeric end as valor
    from {{ ref('ouro_conjuntura_boletim_p3_financiamentos_por_banco') }}
    union all
    select
        'ouro_conjuntura_boletim_p3_financiamentos_por_banco'::text                as modelo,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p4_credito_imobiliario_pib'::text                as modelo,
        4                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p4_no_uh_por_condicao_de_uso'::text                as modelo,
        4                            as pagina,
    ...
    from {{ ref('ouro_conjuntura_boletim_p4_no_uh_por_condicao_de_uso') }}
    union all
    select
        'ouro_conjuntura_boletim_p4_no_uh_por_condicao_de_uso'::text                as modelo,
        4                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p5_sbpe_construcao_no_tri'::text                as modelo,
        5                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p5_poupanca_captacao_liquida'::text                as modelo,
        5                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p5_financiamento_pf_mcmv_por_faixa'::text                as modelo,
        5                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p6_sinapi_brasil_e_incc_m'::text                as modelo,
        6                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p6_ticket_medio_vs_incc'::text                as modelo,
        6                            as pagina,
    ...
    from {{ ref('ouro_conjuntura_boletim_p6_ticket_medio_vs_incc') }}
    union all
    select
        'ouro_conjuntura_boletim_p6_ticket_medio_vs_incc'::text                as modelo,
        6                            as pagina,
    ...
    union all
    select
        'ouro_conjuntura_boletim_p7_indices_da_construcao_variacao'::text                as modelo,
        7                            as pagina,
