...
-- agente CAIXA, copia fiel. Fonte mais rica de historia por empreendimento
...
--
-- Glob na staging: staging/dados_historicos/*ecente_*snh_pmcmv_dados_prioritarios_af_caixa*.parquet
...
{{ bronze_snh_empreendimento('CAIXA') }}
