...
-- `bases_relatorio_executivo` (empreendimento), copia fiel.
--
...
--
-- Glob na staging: staging/dados_historicos/*bases_relat*rio_executivo*.parquet
...
{{ bronze_serie_executiva('bases_relatorio_executivo') }}
