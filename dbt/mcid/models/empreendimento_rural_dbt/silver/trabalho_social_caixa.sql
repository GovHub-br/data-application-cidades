...
-- Fonte: bronze.base_trabalho_social_pnhr_rural_caixa (parquet da staging/ carregado pelo staging_para_bronze.py)
...
with
    ts_caixa_raw as (
        ...
        from {{ source("staging_lake", "base_trabalho_social_pnhr_rural_caixa") }}
    )
