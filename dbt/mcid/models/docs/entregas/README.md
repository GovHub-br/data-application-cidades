...
- `issue-59-evidencias-testes-qualidade-dbt.md`: evidencia de que os 34 modelos de `mcmv_historico_dbt`/`indicadores_mcmv_dbt` passam pela suite de testes dbt de qualidade a cada build (`dbt test` 2026-09-15: PASS=532/WARN=46/ERROR=1, com o unico error e as familias de warn explicados), atendendo o criterio de "resultados validados" da #59. Mesmo recorte de modelos da #130 — serve tambem como evidencia de teste/validacao dos indicadores do reloginho para fechamento daquela issue.
