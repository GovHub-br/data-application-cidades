...
-- Recorte de frente: modalidade = FAR. Chave: normalize_apf(codigo_da_operacao_no_agente_financeiro)
...
with
    snh_raw as (
        select
            ...
            {{ parse_hist_numeric('valor_contratado_original') }} as valor_contratado_original,
            ...
            {{ parse_hist_numeric('valor_desembolsado_em_2025') }} as valor_desembolsado_ano,
            ...
            -- lat/long da SNH vêm num formato não-decimal ("23056620"); mantidas como texto cru
