...
with
    obra_raw as (
        select
            ...
            {{ target.schema }}.parse_date_br(dt_informacao_paralisacao_retomada) as dt_info_paralisacao,
            ...
            {{ target.schema }}.parse_date_br(dt_prev_conclusao_obra_retomada) as dt_previsao_conclusao_retomada,
            ...
            -- Datas de entrega
            {{ target.schema }}.parse_date_br(dt_prev_entrega_emprend) as dt_previsao_entrega,
