...
with
    base as (select * from {{ ref("silver_continuo_manual_trimestrais") }}),
    ...
    unpivoted as (
        ...
        select
            ...
            mrv_var_lancamentos_mesmo_tri_ano_anterior
            as var_lancamentos_mesmo_tri_ano_anterior,
            mrv_var_lancamento_acumulado_mesmo_periodo_ano_anterior
            as var_lancamentos_acumulado_periodo_ano_anterior,
            ...
            mrv_var_vendas_acumulado_mesmo_periodo_ano_anterior
            as var_vendas_acumulado_periodo_ano_anterior
        from base
