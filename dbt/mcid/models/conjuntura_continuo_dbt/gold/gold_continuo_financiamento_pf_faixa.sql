...
where coalesce(financiamento_pf_uh_total_faixa_1, financiamento_pf_uh_total_faixa_2,
               financiamento_pf_uh_total_faixa_3, financiamento_pf_uh_total_classe_media) is not null
