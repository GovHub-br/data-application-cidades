...
@dag(
    schedule=get_dynamic_schedule("historico_pagamentos_especiais_ingest_dag"),
    ...
    def fetch_and_store_historico_pagamentos_especiais() -> None:
        ...
        if historico_data and len(historico_data) > 0:
            ...
            logging.info(
                ...
                f"{len(historico_data)} registros de histórico de pagamentos "
                f"especiais no schema transfere_gov"
            )
            db.insert_data(
                historico_data,
