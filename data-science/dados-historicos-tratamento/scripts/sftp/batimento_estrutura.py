...
def main() -> None:
    ...
    logger.info("Carregando artefatos de: %s (schema_dump=%s)", artefatos_dir, schema_dump)
    ...
    caminhos: dict[str, Path] = {
        ...
        "divergencias_estrutura.csv": output_dir / f"divergencias_estrutura{suffix}.csv",
    }
