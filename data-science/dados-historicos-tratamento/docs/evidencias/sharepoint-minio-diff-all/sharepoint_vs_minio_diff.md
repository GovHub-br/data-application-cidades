...
| bronze | nao_classificado | nao_identificada | .parquet | 230 |
...
| audit | nao_classificado | nao_identificada | .parquet | 41 |
...
| test | far | entregas | .csv | 1 |
| test | far | entregas | .parquet | 1 |
