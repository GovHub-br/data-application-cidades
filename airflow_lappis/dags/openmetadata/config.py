...
OPENMETADATA_GLOSSARY_PATH = (
    f"{AIRFLOW_REPO_BASE}/dags/openmetadata/glossaries/mcid.yaml"
)
OPENMETADATA_SEMANTIC_RELATIONSHIPS_PATH = (
    f"{AIRFLOW_REPO_BASE}/dags/openmetadata/semantic_relationships/mcid.yaml"
)
DBT_IPEA_DIR = f"{AIRFLOW_REPO_BASE}/dags/dbt/mcid"
