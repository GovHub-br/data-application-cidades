...
with
    cad_pj_raw as (
        select
            ...
            {{ parse_hist_numeric('vr_total_contrapartidas') }} as vr_total_contrapartidas,
            ...
            {{ parse_hist_numeric('vr_equipamentos_publicos') }} as vr_equipamentos_publicos,
            ...
            {{ parse_hist_numeric('vr_contrapartida_estado_infra') }} as vr_contrapartida_estado_infra,
            {{ parse_hist_numeric('vr_contrapartida_estado_terreno') }} as vr_contrapartida_estado_terreno,
            {{ parse_hist_numeric('vr_contrapartida_estado_complementar') }} as vr_contrapartida_estado_complementar,
            {{ parse_hist_numeric('vr_contrapartida_municipio_infra') }} as vr_contrapartida_municipio_infra,
            {{ parse_hist_numeric('vr_contrapartida_municipio_terreno') }} as vr_contrapartida_municipio_terreno,
            {{ parse_hist_numeric('vr_contrapartida_municipio_complementar') }} as vr_contrapartida_municipio_complementar,
            {{ parse_hist_numeric('vr_contrapartida_outras') }} as vr_contrapartida_outras,

            -- Aporte / Retomada
            nullif(trim(nu_apf_aporte_suplementacao), '') as apf_aporte,
            {{ parse_int('co_operacao_retomada') }} as co_operacao_retomada,
            {{ parse_hist_numeric('vr_contratado_aporte_suplementacao') }} as vr_aporte_suplementacao,
            {{ parse_date_br('dt_contratacao_aporte_suplementacao') }} as dt_aporte_suplementacao,
            ...
            {{ parse_hist_numeric('vr_sistema_alternativo_de_energia') }} as vr_energia_alternativa,
            {{ parse_hist_numeric('vr_sistema_aquecimento_solar') }} as vr_aquecimento_solar,
