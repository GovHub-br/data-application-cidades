...
-- Bronze: Dados Prioritários Banco do Brasil (Rural)
-- Fonte: dados_prioritarios_recebidos_bb_empreendimentos
...
with
    prioritarios_raw as (
        ...
        from {{ source("raw", "dados_prioritarios_recebidos_bb_empreendimentos") }}
