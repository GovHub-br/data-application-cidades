...
acum_26 AS (
    ...
    SELECT
        nome_empresa,
        SUM(lancamento) AS lancamento_12m_26
...
acum_25 AS (
    ...
    SELECT
        nome_empresa,
        SUM(lancamento) AS lancamento_12m_25
...
acum_24 AS (
    ...
    SELECT
        nome_empresa,
        SUM(lancamento) AS lancamento_12m_24
...
SELECT
    ...
    ROUND(
        (
            (atual.lancamento::numeric / NULLIF(q4.lancamento, 0)) - 1
        ) * 100,
        0
    ) AS variacao_4t25,
    ...
    ROUND(
        (
            (atual.lancamento::numeric / NULLIF(t25.lancamento, 0)) - 1
        ) * 100,
        0
    ) AS variacao_1t25,
    ...
    ROUND(
        (
            (a26.lancamento_12m_26::numeric / NULLIF(a25.lancamento_12m_25, 0)) - 1
        ) * 100,
        0
    ...
    ROUND(
        (
            (a25.lancamento_12m_25::numeric / NULLIF(a24.lancamento_12m_24, 0)) - 1
        ) * 100,
        0
